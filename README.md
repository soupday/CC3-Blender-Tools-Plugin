...
This is a python plugin for Character Creator 3 to re-import a character from Blender generated using the **CC3 Blender Pipeline Tool** auto-setup add-on: https://github.com/soupday/cc_blender_tools.
